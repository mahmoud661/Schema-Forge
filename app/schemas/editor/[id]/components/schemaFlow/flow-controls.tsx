  ...
  return (
    <>
      <Background
        ...
        gap={20}
        size={1}
        color={backgroundPattern === "lines" ? "var(--border-color)" : ""}        className="transition-all duration-300"
      />

      {showMinimap && (
        <MiniMap
          nodeColor={(node) =>
            (node.data?.color as string) || "hsl(var(--primary))"
          }
